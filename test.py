...
# Replace this URL with any TikTok video URL you want transcript for
payload = {
    "videoUrls": [
        "https://www.tiktok.com/@goodmorningbritain/video/7253032811098066203"
    ]
}
...
try:
    ...
    subtitles = re.sub(r"\d{2}:\d{2}:\d{2}\s*-->\s*\d{2}:\d{2}:\d{2}\n?", "", subtitles)
